...
template<int d1,int d2,int d3>
static void MatrixMul13(benchmark::State& state) {
  // L1_CACHE 256 * 1024
  // L1_CACHE LINE 64
  float* in1 = (float*)malloc(sizeof(float) * d2 * d1);
  float* in2 = (float*)malloc(sizeof(float) * d2 * d3);
...
template<int d1,int d2,int d3>
static void MatrixMul16(benchmark::State& state) {
  // L1_CACHE 256 * 1024
  // L1_CACHE LINE 64
  float* in1 = (float*)malloc(sizeof(float) * d2 * d1);
  float* in2 = (float*)malloc(sizeof(float) * d2 * d3);
...
// BENCHMARK_TEMP_SMMALL(MatrixMul13);
// BENCHMARK_TEMP_SMMALL(MatrixMul14);
// BENCHMARK_TEMP(MatrixMul15);
// BENCHMARK_TEMP(MatrixMul16);
